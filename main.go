...
func init() {
	todo1 := Todo{UserID: 1, FirstName: "Andriy", LastName: "Yakymiv"}
	todo2 := Todo{UserID: 2, FirstName: "Yaroslav", LastName: "Yakymiv"}
	todo3 := Todo{UserID: 3, FirstName: "Ivanna", LastName: "Yakymiv"}
